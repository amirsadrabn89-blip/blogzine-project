        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav navbar-nav-scroll mx-auto">
                    ...
                    <!-- Nav item -->
                    <li class="nav-item"><a class="nav-link" href="{{ route('user.dashboard.page') }}"><i class="bi bi-person me-1"></i>پیشخوان من</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu p-0 rounded-3" aria-labelledby="postMenu">
                            ...
                            <li><a class="dropdown-item border-bottom rounded-3" href="{{ route('user.my-articles.page') }}">خبر های من</a> </li>
                            <li><a class="dropdown-item border-bottom rounded-3" href="{{ route('dashboard-post-create.page') }}">ایجاد خبر</a> </li>
                        </ul>
                    </li>

                    <!-- Nav item -->
                    <li class="nav-item"><a class="nav-link" href="{{ route('user.support-messages.page') }}"><i class="bi bi-bell fa-fw me-1"></i>پیام ها</a></li>
            ...
            <div class="nav flex-nowrap align-items-center">
                ...
                <div class="nav-item ms-2 ms-md-3 dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3 rounded-3" aria-labelledby="profileDropdown">
                        ...
                        <li><a class="dropdown-item" href="{{ route('user.my-articles.page') }}"><i class="bi bi-newspaper fa-fw me-2"></i>خبر های من</a></li>
                        <li><a class="dropdown-item" href="{{ route('dashboard-post-create.page') }}"><i class="bi bi-plus-circle fa-fw me-2"></i>ایجاد خبر</a></li>
                        <hr class="my-1">
                        <li><a class="dropdown-item" href="{{ route('users_help-and-rules.page') }}"><i class="bi bi-info-circle fa-fw me-2"></i>راهنما و قوانین کاربران</a></li>
                        <li>
                            @auth
