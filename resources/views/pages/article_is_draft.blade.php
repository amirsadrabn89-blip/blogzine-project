            ...
            <div class="row">
                <div class="col-md-9 text-center mx-auto position-relative z-index-9 border py-5 rounded-5 my-5 bg-secondary bg-opacity-10">
                    ...
                    <p class="text-muted lh-lg mb-4">
                        متأسفانه این مقاله موقتاً غیرفعال شده است و امکان مشاهده
                        محتوای آن وجود ندارد. لطفاً مقالات دیگر را بررسی کنید.
                    </p>

                    <a href="{{ route('post-grid-masonry-filter.page') }}" class="btn btn-primary rounded-pill px-4">
